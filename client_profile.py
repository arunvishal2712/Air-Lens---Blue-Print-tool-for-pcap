...
def decode_11v(ie_data):
    """Safely checks for BSS Transition Management capability support."""
    return "Yes" if len(ie_data) > 0 else "No"

def infer_client_capabilities(pkt):
    ies = extract_ies(pkt)
    ...
    profile = {
        ...
        "MLO_Mode": "N/A",
        "MLO_Link_Count": "N/A",
        "Associated_BSSID": getattr(pkt, "addr1", None)
    }
    ...
    if 127 in ies:
        profile["11v_BSS_Transition"] = decode_11v(ies[127][0])
